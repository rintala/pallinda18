...
func main() {
	...
	//Add all producers to waitgroup
	wgp.Add(producers)
	...
	//Placing it after close of channel, since the loop in Consume will only
	//end when the channel is closed (for loop: for s:= range ch..)
	wgpc.Wait()
